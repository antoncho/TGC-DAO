  ...
  return (
    ...
    >
      <svg viewBox={`0 0 ${width} ${height}`} fill="none" className="h-full">
        ...
        <defs>
          <clipPath id={`${id}-clip`} transform={`translate(${width}, 0) scale(-1, 1)`}>
            <path
              id={`${id}-shape`}
              d={path}
              fillRule="evenodd"
